...
public class PostsByEmotionAdapter extends BasePostsAdapter {
    public static final String TAG = PostsByUserAdapter.class.getSimpleName();

//    private String userId;
    private int emotion;
    private PostsByUserAdapter.CallBack callBack;

    public PostsByEmotionAdapter(final BaseActivity activity, int emotion) {
        super(activity);
    ...
    public void loadPosts() {
        ...
        PostManager.getInstance(activity).getPostsListByEmotion(onPostsDataChangedListener, emotion);
    }
